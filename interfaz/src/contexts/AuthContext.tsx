    ...
    try {
      ...
      if (data.success && data.data?.user) {
        ...
        setUser({
          ...
          isFirstLogin: data.data.user.isFirstLogin ?? (localStorage.getItem('isFirstLogin') === 'true'),
        });
        setToken(storedToken);
    ...
    try {
      ...
      if (data.success && data.data?.token) {
        ...
        if (data.data.user) {
          ...
          localStorage.setItem('isFirstLogin', data.data.user.isFirstLogin ? 'true' : 'false');
        }
