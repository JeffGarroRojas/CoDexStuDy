...
import { Loader2, Mail, AlertCircle, CheckCircle, ShieldCheck, Zap } from 'lucide-react';
...
export default function VerificarPage() {
  ...
  const [code, setCode] = useState(IS_DEV ? ['1', '2', '3', '4', '5', '6'] : ['', '', '', '', '', '']);
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
      ...
      >
        ...
        >
          ...
          {IS_DEV && (
            <div className="mt-2 inline-flex items-center gap-1 px-2 py-1 bg-yellow-100 text-yellow-800 text-xs rounded-full">
              <Zap className="w-3 h-3" />
              Modo desarrollo: código 123456
            </div>
          )}
        </motion.div>
