...
import { Loader2, Mail, Lock, AlertCircle, LogIn, CheckCircle } from 'lucide-react';
          ...
          <AnimatePresence>
            {success && (
              ...
              >
                ...
                <div>
                  <p className="text-sm font-medium text-green-700">¡Sesión iniciada!</p>
                  <p className="text-xs text-green-600">Redireccionando...</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
